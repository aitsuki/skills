...
**1. Fresh Session** - Start a new session and ask it to use `$executing-plans` with this saved plan

**2. Inline Execution** - Continue in this session using `$executing-plans`
